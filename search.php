<?php
    ...
    $query = "SELECT book_isbn, book_image FROM books WHERE book_title like '%$book_isbn%' or book_isbn like '%$book_isbn%' or book_author like '%$book_isbn%' or courseNo like '%$book_isbn%' or profName like '%$book_isbn%'";
